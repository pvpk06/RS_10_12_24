      ...
      .then(data => {
        ...
        if (Array.isArray(data) && data.length > 0) {
          ...
          if (profileData.profile_img) {
            ...
            setProfileImage(`http://194.238.17.64:5001/uploads/profiles/${profileData.profile_img}`);
          }
        }
      })
      ...
      apiService.post(`/api/upload-profile-image/${internID}`, formDataWithImage)
        ...
        .catch(error => {
          ...
          if (formData.profile_img) {
            setProfileImage(`http://194.238.17.64:5001/uploads/profiles/${formData.profile_img}`);
          } else {
